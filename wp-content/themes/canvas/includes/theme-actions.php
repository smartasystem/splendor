...
function woo_load_responsive_IE_footer () {
	$html = '<!--[if lt IE 9]>'. "\n";
	$html .= '<script src="' . get_template_directory_uri() . '/includes/js/respond.js"></script>'. "\n";
	$html .= '<![endif]-->'. "\n";
...
function woo_remove_responsive_design () {
	...
	// Remove call to respond.js in the footer.
	remove_action( 'wp_footer', 'woo_load_responsive_IE_footer', 10 );
...
<!-- Adjust the website width -->
<style type="text/css">
.col-full, #wrapper  { width: <?php echo intval( $layout_width ); ?>px; }
</style>
